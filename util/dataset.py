...
class SemData(Dataset):
    ...
    def __init__(self, split='train', transform=None, data_root=None, num_classes=None,\
                 ignore_label=None, scale=None, data_list_file=None, poison_list=None,\
                    poisoned_label_folder=None, poisoned_image_folder=None, rpl=None,\
                        rpl_clean_label_folder=None, data_list=None):
    ...
    def _load_normal_data(self, image_path, label_path, label_name):
        ...
        try:
            ...
            if self.RPL and os.path.exists(rpl_clean_label_path):
                with open(rpl_clean_label_path, 'rb') as f:
                    label = pickle.load(f)
            else:
    ...
    def __init__(self, split=None, transform=None, args=None, backdoor_info=None):
        ...
        self.rpl_clean_label_folder = backdoor_info.rpl_clean_label_folder
